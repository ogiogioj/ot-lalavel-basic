...
class ArticleControllerTest extends TestCase
{
    ...
    public function 로그인한_사용자는_글쓰기_화면을_볼수있다(): void
    {
    ...
    public function 로그인하지_않은_사용자는_글쓰기_화면을_볼수없다(): void
    {
        $user = User::factory()->create();
    ...
    public function 로그인한_사용자는_글을_작성할_수_있다(): void
    {
        $testData =   [
            'body' => 'test article'
        ];
    ...
    public function 로그인한_사용자는_글수정_화면을_볼수있다(): void
    {
        $user = User::factory()->create();
    ...
    public function 로그인하지_않은_사용자는_글수정_화면을_볼수없다(): void
    {
    ...
    public function 로그인_하지_않은_사용자는_글을_수정할_수_없다(): void
    {
    ...
    public function 로그인_하지_않은_사용자는_글을_삭제할_수_없다(): void
    {


        $article = Article::factory()->create();
        $this->delete(route('articles.destroy', ['article' => $article->id]))
            ->assertRedirectRoute('login');
